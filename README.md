...
- Switching to Messenger still counts for Wait and behind for 30 minutes. After 30 minutes they show as last report, their clock pauses, and they no longer set the banner. After 45 minutes they drop off.
...
1. Open the page.
2. Enter your name, a room code, and the match clock on your TV. If the room already has people, the picker starts from the live edge. Use + / − or tap the digits and type `1040` for 10:40.
